...
class Ui_CamShow(object):
    def setupUi(self, CamShow):
        ...
        self.label_2.setGeometry(QtCore.QRect(50, 40, 411, 216))
        ...
        self.btnAdd.setGeometry(QtCore.QRect(570, 10, 101, 31))
        self.btnAdd.setObjectName("btnAdd")
        self.draw = PlotWidget(self.centralwidget)
        self.draw.setGeometry(QtCore.QRect(570, 50, 381, 281))
        self.draw.setObjectName("draw")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(560, 420, 141, 31))
        self.label_8.setStyleSheet("font: 12pt \"Calibri\";")
        self.label_8.setObjectName("label_8")
        self.draw_2 = PlotWidget(self.centralwidget)
        self.draw_2.setGeometry(QtCore.QRect(560, 460, 411, 216))
